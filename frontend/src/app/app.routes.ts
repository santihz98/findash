...
export const routes: Routes = [
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./features/accounts/containers/account-list.page').then((m) => m.AccountListPage),
  },
  {
    path: 'transfer',
    canActivate: [roleGuard(['CLIENT'])],
    loadComponent: () =>
      import('./features/transfer/containers/transfer-form.page').then((m) => m.TransferFormPage),
  },
];
